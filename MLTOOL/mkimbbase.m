...
% VOIR AUSSI :
%
%   UIMKIMBBASE  IMBGET  BASE2TARGET  BASE2LABEL
% 
...
%  - B. Gas (12/11/2001): bug lors de la saisie du nombre ClassNbr
...
ClassNbr = input('Nombre de classes différentes désirées = ');
