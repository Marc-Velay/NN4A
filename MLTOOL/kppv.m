function Class=kppv(BaseKppv, Label, BaseTest, k, opt);
%
% KPPV
%
% SYNTAXE :
...
%  - B. Gas (12/8/2001) : gestion de l'erreur k > KppvExNbr 
...
if k>KppvExNbr
   error('[KPPV] erreur : K ne peut être supérieur au nombre d''exemples de la base');
end;
