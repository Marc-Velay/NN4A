function mlp2front(Base, Labels, W1, B1, W2, B2);
%
% MLP2FRONT
%
% SYNTAXE :
...
% W1, B1, W2, B2 : poids du réseau MLP2
%
% VALEURS DE RETOUR :
%
% -
...
if nargin ~= 6
   error('Usage : mlp2front Base Labels W1, B1, W2, B2');
end;
...
% classification :
Output = mlp2run(BaseTst, W1, B1, W2, B2);
...
hold off
disp('[MLP2FRONT] : tapez <Return> pour continuer...');
pause;
